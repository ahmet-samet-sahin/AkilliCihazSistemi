...
public class Ekran implements IEkran {
    ...
    public void menu(String username) {
        ...
        System.out.println("1- Sicaklik Algila");
        System.out.println("2- Sogutucuyu Ac");
        System.out.println("3- Sogutucuyu Kapat");
        System.out.println("4- Sicaklik Degeri Uyaricisini Calistir (Observer)");
	 ...
	 @Override
	    ...
	    public void anaMenuyeDonusMesaj() throws InterruptedException {
	        Thread.sleep(300);
	        System.out.println("Hatali giris yaptiniz, ana menuye donduruluyorsunuz.");
	        Thread.sleep(300);
	        System.out.println("Hatali giris yaptiniz, ana menuye donduruluyorsunuz..");
	        Thread.sleep(300);
	        System.out.println("Hatali giris yaptiniz, ana menuye donduruluyorsunuz...");
