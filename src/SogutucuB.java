...
public class SogutucuB implements ISogutucu{
    ...
    public SogutucuB(String sogutucuAdi , String sogutucuMarkasi,Integer sogutucuGarantiSuresi,String sogutucuOrijinalMi) {
    ...
    public void sogutucuAc(IAlgilayici algilayici) {
        if(algilayici.degerGetir() == null)
            ...
            if(algilayici.degerGetir() <5)
                ...
                algilayici.yeniDeger(algilayici.degerGetir() - 10);
